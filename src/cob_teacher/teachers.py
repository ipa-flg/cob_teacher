...
class MAG_TeachInHandleTeacher(TeacherPlugin):
    current_pose = PoseStamped()
    def __init__(self):
    ...
    def getName(self):
        return "MAG_TeachInHandleTeacher"
...
class DTI_TeachInHandleTeacher(TeacherPlugin):
    current_pose = PoseStamped()
    def __init__(self):
        # start listener for pose 
        self.listener = rospy.Subscriber('/DTI_teach_handle_pose', PoseStamped, self.callback)
        pass
    ...
    def getName(self):
        return "DTI_TeachInHandleTeacher"
